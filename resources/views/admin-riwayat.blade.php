		...
		<div class="col-md-3 bg-secondary mt-2 pr-3 pt-4 kolom">
			...
			<ul class="nav flex-column text-white ml-5 mb-5 ">
			  ...
			  <li class="nav-item aktif">
			    <a class="nav-link  text-primary" href="{{url('/admin/riwayat')}}"><i class="fas fa-scroll"></i>Riwayat</a>
			    <hr class="bg-white m-0">
			  </li>
			  <li class="nav-item">
				...
				<table class="table">
				  ...
				  <tbody>
			  		@if($transaksi->isEmpty())
			  			<tr>
			  				<td class="text-center bg-light" colspan="7">Tidak ada transaksi hari ini</td>
			  			</tr>
			  		@else
